...
audio20 = fs.readFileSync('./Z3/Ramdani20.m4a') 
            ...
            nayla.sendMessage(mdata.id,  nnnyz6, MessageType.buttonsMessage,{caption: 'whatsapp',"contextInfo": {text: 'ALIF BOTZ', "forwardingScore": 1000000000, isForwarded: true, sendEphemeral: true, "mentionedJid" : [memJid], },sendEphemeral: true})                         
			}
		...
		//	if (nay.key.fromMe) return
            ...
            if (isBanned) return reply("MAAF ANDA TELAH DI BANNED") 			 
         	...
         	.on('end', function () {
         	console.log('SELESAI JANGAN LUPA SUBSCRIBE YT ALIF ANANTA')
